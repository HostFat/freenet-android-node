...
(currently core 0.2.137) on your phone. It starts and stops the node for you,
...
git checkout v0.2.137   # optional: build the exact commit behind a specific release
