# Developing Freenet Android Node

This is the technical companion to the [README](../README.md): build
instructions, checks, architecture notes, and the manual/automated proofs
used during development. If you just want to run the app, the README's
"Get the app" section is all you need.
...
[`docs/BASELINE.md`](BASELINE.md), [`docs/PORTING_NOTES.md`](PORTING_NOTES.md),
and the architecture decision record in
[`docs/adr/0001-embed-freenet-with-jni.md`](adr/0001-embed-freenet-with-jni.md).
The gate results are in [`docs/PHASE_0_1_REPORT.md`](PHASE_0_1_REPORT.md),
[`docs/PHASE_2_REPORT.md`](PHASE_2_REPORT.md), and
[`docs/PHASE_3_REPORT.md`](PHASE_3_REPORT.md), and
